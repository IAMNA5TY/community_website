...
const { fetchChannelV2 } = require("./kick-channel-client");
...
const DEBUG_SLUGS = new Set(
  String(process.env.KICK_CHAT_DEBUG_SLUGS || "andy1993")
    .split(",")
...
class StreamMonitor {
  ...
  async start() {
    ...
    const channel = await fetchChannelV2(this.slug);
