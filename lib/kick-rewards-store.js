...
function removeMonitoredStreamer(slug) {
  ...
  return {
    slug: normalized,
    removed: store.monitoredChannels.length < before,
    locked: false,
  };
}
...
// Partners come from FiveM sync (POST /monitored-streamers) + optional env.
// No hardcoded partner list — Kick City "Add New Streamer" is the source of truth.
