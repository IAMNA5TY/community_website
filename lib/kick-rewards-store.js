...
function recordChatMessage({
  ...
  if (id) {
    ...
    // Soft dedupe only when Kick did not send a message id (dual Pusher / webhook).
    // Same emote/text with a unique id is a real chat and must count as a Kick Point.
