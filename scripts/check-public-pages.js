...
assert(access.isPublicOverlayApiPath("/twitch/live"), "Twitch live status is public");
assert(access.isPlayerAllowedApiPath("/twitch/live"), "signed-in Kick viewers can poll Twitch live");
